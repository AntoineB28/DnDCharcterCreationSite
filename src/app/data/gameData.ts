...
export const CLASSES: ClassData[] = [
  {
    ...
    startingEquipment: ["Arme à deux mains OU deux armes à une main OU arme + bouclier (AC+2)", "Armure d'acier (lourde, AC 15)"],
  ...
  },
  {
    ...
    startingEquipment: ['Trois sorts niveau 1 au choix', 'Robes de mage', 'Une arme simple au choix', 'Mana +4'],
